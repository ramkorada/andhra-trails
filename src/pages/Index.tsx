    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-screen flex items-end">
        ...
        <div className="relative z-10 container mx-auto px-4 pb-20 md:pb-28">
          <p className="text-primary-foreground/70 text-sm font-medium tracking-widest uppercase mb-4 animate-fade-in">
          ...
          <Link
            to="/destinations"
            className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-lg font-semibold hover:bg-primary/90 transition-colors opacity-0 animate-fade-in"
      ...
      <section className="section-padding bg-background">
        <div className="container mx-auto">
          ...
          <p className="text-muted-foreground text-center max-w-lg mx-auto mb-12">
            From misty hill stations to ancient temples and pristine beaches — Andhra Pradesh has it all.
          </p>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <Link
                to="/destinations"
                key={cat.label}
                className="card-hover group flex flex-col items-center text-center p-8 rounded-xl border border-border bg-card opacity-0 animate-fade-in"
      ...
      <section className="section-padding bg-muted/50">
        <div className="container mx-auto">
          <div className="flex items-end justify-between mb-12">
            ...
            <Link
              to="/destinations"
              className="hidden md:inline-flex items-center gap-1 text-sm font-semibold text-primary hover:text-primary/80 transition-colors"
            >
      ...
      <section className="section-padding bg-primary text-primary-foreground">
        <div className="container mx-auto text-center max-w-2xl">
          ...
          <p className="text-primary-foreground/80 text-lg mb-8">
            Preserve the beauty of Andhra Pradesh for future generations. Learn how you can make a difference with every trip.
          </p>
          <Link
            to="/eco-awareness"
